...
TEXTOS = {
    "es": [
        ...
        ("horario", "Solo suena <em>cuando tiene que sonar</em>",
         "Elige los días y las horas de cada alarma. Fuera de eso, silencio.", True),
    ...
    "en": [
        ...
        ("horario", "Only when it <em>should</em> ring",
         "Pick the days and the hours of each alarm. Outside them, it stays quiet.", True),
